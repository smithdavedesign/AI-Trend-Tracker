...
const toolsSeed = [
  ...
  { id: "langchain", name: "LangChain", category: "agents" as const, pricingTier: "free" as const, selfHostable: true, githubUrl: "https://github.com/langchain-ai/langchain", websiteUrl: "https://langchain.com" },
  { id: "langgraph", name: "LangGraph", category: "agents" as const, pricingTier: "free" as const, selfHostable: true, githubUrl: "https://github.com/langchain-ai/langgraph", websiteUrl: "https://langchain.com/langgraph" },
  ...
  { id: "n8n", name: "n8n", category: "agents" as const, pricingTier: "freemium" as const, selfHostable: true, githubUrl: "https://github.com/n8n-io/n8n", websiteUrl: "https://n8n.io" },
  { id: "flowise", name: "Flowise", category: "agents" as const, pricingTier: "free" as const, selfHostable: true, githubUrl: "https://github.com/FlowiseAI/Flowise", websiteUrl: "https://flowiseai.com" },
  ...
  // ─── Infrastructure ────────────────────────────────────
  { id: "ollama", name: "Ollama", category: "infra" as const, pricingTier: "free" as const, selfHostable: true, githubUrl: "https://github.com/ollama/ollama", websiteUrl: "https://ollama.com" },
  ...
  { id: "huggingface", name: "Hugging Face", category: "infra" as const, pricingTier: "freemium" as const, selfHostable: false, githubUrl: "https://github.com/huggingface/transformers", websiteUrl: "https://huggingface.co" },
  ...
  { id: "together-ai", name: "Together AI", category: "infra" as const, pricingTier: "paid" as const, selfHostable: false, githubUrl: null, websiteUrl: "https://together.ai" },
  { id: "groq", name: "Groq", category: "infra" as const, pricingTier: "freemium" as const, selfHostable: false, githubUrl: null, websiteUrl: "https://groq.com" },
  { id: "replicate", name: "Replicate", category: "infra" as const, pricingTier: "paid" as const, selfHostable: false, githubUrl: null, websiteUrl: "https://replicate.com" },
  { id: "chromadb", name: "ChromaDB", category: "infra" as const, pricingTier: "free" as const, selfHostable: true, githubUrl: "https://github.com/chroma-core/chroma", websiteUrl: "https://trychroma.com" },
  ...
  { id: "elevenlabs", name: "ElevenLabs", category: "vertical" as const, pricingTier: "freemium" as const, selfHostable: false, githubUrl: null, websiteUrl: "https://elevenlabs.io" },
